...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['owner', 'deleted'], ['deleted']) }} as owner_deleted,
    ...
    {{ json_extract_scalar('_airbyte_data', ['createdBy', 'email'], ['email']) }} as createdBy_email,
    ...
    {{ json_extract_scalar('_airbyte_data', ['createdBy', 'deleted'], ['deleted']) }} as createdBy_deleted,
    {{ json_extract_scalar('_airbyte_data', ['contact', 'email'], ['email']) }} as contact_email,
    ...
    {{ json_extract_scalar('_airbyte_data', ['job', 'source'], ['source']) }} as job_source,
    {{ json_extract_scalar('_airbyte_data', ['job', 'jobTitle'], ['jobTitle']) }} as job_jobTitle,
    {{ json_extract_scalar('_airbyte_data', ['job', 'status', 'name'], ['name']) }} as job_status_name,
    {{ json_extract_scalar('_airbyte_data', ['job', 'status', 'active'], ['active']) }} as jobs_status_active,
    {{ json_extract_scalar('_airbyte_data', ['job', 'status', 'statusId'], ['statusId']) }}as jobs_status_statusId,
    _airbyte_ab_id,
    _airbyte_emitted_at,
